...
if __name__ == '__main__':
    ...
    end_time = int(end)
    period = '5min'
    ticker = ['btcusdt', 'ethusdt', 'trxusdt', 'shibusdt', 'solusdt', 'dotusdt',
    ...
    for i in ticker[20:]:
        data = Huobi_kline(symbol=i, period=period, start_time=start_time, end_time=end_time, get_full_market_data=True, col_with_asset_name=False)
        data.to_csv('{}_5min_20210512_20220312.csv'.format(i))
        print(i)
    print('\a')
